export const FULL_QUIZ_QUESTIONS = [
    ...
    },
    {
        ...
        config: {
            level1Label: 'Area of Interest',
            level2Label: 'Specific Focus',
            options: {
                'Innovation & Technology': [
                    { value: 'entrepreneurship', label: 'Entrepreneurship & Business Innovation' },
                    { value: 'technology', label: 'Computer Science & Technology' },
                    { value: 'engineering', label: 'Engineering & Biotech' },
                    { value: 'sustainability', label: 'Environmental & Sustainability' },
                    { value: 'data_science', label: 'Data Science & Analytics' }
                ],
                'Leadership & Influence': [
                    { value: 'business_leadership', label: 'Business & Management' },
                    { value: 'government', label: 'Government & Political Science' },
                    { value: 'communications', label: 'Communications & Media Strategy' },
                    { value: 'international_relations', label: 'International Relations' },
                    { value: 'policy', label: 'Public Policy & Administration' }
                ],
                'Arts & Creative Expression': [
                    { value: 'music', label: 'Music & Performance' },
                    { value: 'film', label: 'Film & Media Production' },
                    { value: 'liberal_arts', label: 'Liberal Arts & Literature' },
                    { value: 'creative_writing', label: 'Creative Writing & Languages' },
                    { value: 'interdisciplinary_arts', label: 'Interdisciplinary Arts' }
                ],
                'Social Impact & Human Services': [
                    { value: 'social_work', label: 'Social Work & Community Development' },
                    { value: 'emergency_management', label: 'Emergency & Disaster Management' },
                    { value: 'conflict_resolution', label: 'Conflict Resolution & Mediation' },
                    { value: 'public_health', label: 'Public Health & Safety' },
                ...
                'Exploratory & Interdisciplinary': [
                    ...
                    { value: 'dual_degree', label: 'Dual degree programs' },
                    { value: 'interdisciplinary', label: 'Interdisciplinary studies' },
                    { value: 'research', label: 'Research & Academia' },
                    { value: 'global_studies', label: 'Global & Cultural Studies' }
                ]
            }
        }
    },
    ...
    // RIASEC Results Filler
    {
        ...
        type: 'statement',
        title: "Great! I've captured your interests.",
        description: "Your activity preferences will help me understand what types of careers and academic programs might be the best fit for you. I'll analyze your responses and include detailed insights in your final report.",
        required: false
    },
