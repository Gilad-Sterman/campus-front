...
const GatedFeatureLanding = ({ title, subtitle, points, ctaTo, color }) => {
  return (
    <section className="quiz-start-page gated-feature-quiz">
      <div className="quiz-start-hero" style={{ backgroundColor: color }}>
      ...
      <div className="quiz-card-container">
        {points.map((point, index) => (
          <div key={index} className="quiz-start-card">
